...
### main
ax=le("results/iris_ax.txt"); ay=le("results/iris_ay.txt")
qx=le("results/iris_qx.txt"); qy=le("results/iris_qy.txt")
...
plt.tight_layout(); plt.show(); fig.savefig("results/iris_dt2a.png")
...
plt.tight_layout(); plt.show(); fig.savefig("results/iris_dt2b.png")
